...
Define how users discover crossword entries using combined filters and deterministic matching.

## Requirements

### Requirement: Users can search clues by clue text
The system SHALL provide a text search input that filters displayed entries by clue text using case-insensitive matching.
